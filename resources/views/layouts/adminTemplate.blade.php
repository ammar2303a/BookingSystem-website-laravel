...
<html lang="en">
  <head>
    ...
    <title>Cinema World (Admin)</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.html"><h2 class= "text-warning">Cinema World</h2></a>
        </div>
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <!-- <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="{{asset('adminAssets/images/faces/face15.jpgcss')}}" alt="">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="cinema">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/addcinema">Add Cinemas</a></li>
              </ul>
            </div>
          </li>

          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ticketclasses" aria-expanded="false" aria-controls="ticketclasses">
              <span class="menu-icon">
                <i class="mdi mdi-theater"></i>
              </span>
              <span class="menu-title">Ticket Class</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ticketclasses">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/addticketclasses">Add Ticket Class</a></li>
              </ul>
            </div>
          </li>

          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#shows" aria-expanded="false" aria-controls="shows">
              <span class="menu-icon">
            ...
            <div class="collapse" id="shows">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/addshow">Add Shows</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="movie">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/addmovie">Add Movies</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="review">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/addreview"> Manage Reviews</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="booking">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/addbooking"> Manage Bookings</a></li>
              </ul>
            </div>
          </li>
          <!-- <li class="nav-item menu-items">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="index.html"><h2>Cinema World</h2></a>
          </div>
             ...
             <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown border-left">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="{{asset('adminAssets/images/faces/face4.jpg')}}" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="{{asset('adminAssets/images/faces/face2.jpg')}}" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
                  ...
                  <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <img src="{{asset('adminAssets/images/faces/face3.jpg')}}" alt="image" class="rounded-circle profile-pic">
                    </div>
                    <div class="preview-item-content">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <!-- <img class="img-xs rounded-circle" src="{{asset('adminAssets/images/faces/face15.jpg')}}" alt=""> -->
                    @if(Auth::check())
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <form method="POST" action="{{ route('logout') }}" x-data>
                                @csrf
                              <button type="submit" class="lagdashbtn">  <p class="preview-subject mb-1">logout</p></button>
</form>
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
