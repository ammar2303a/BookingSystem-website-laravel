...
<head>
        ...
        <title>Cinema World - Online Movies & TV Shows Template</title>
                                ...
                                <nav class="menu-nav show">
                                    ...
                                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                                        <ul class="navigation">
                                            ...
                                            <li class="menu-item-has-children"><a href="/addcinema">Cinema</a>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="copyright-text">
                                <p>Copyright &copy; 2021. All Rights Reserved By <a href="index.html">Cinema World</a></p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
